...
if __name__ == '__main__':
	...
	#   supercoords = [[10],[20],[10],[0]]  original array

	counter = 0 # I added code

	while counter < 3: # i added code
		supercoords = [[-60],[0],[-60],[0]]  #first member array seems to distance  x1, beginning second is x2 ending , third x3  2nd beginning and x4 is the sencond ending
		#supercoords = [[10],[20],[10],[0]]  original array
		#supercoords =  [[-5],[0],[-5],[0]] tended just bend the box
		for coords in supercoords:
			...
			while status['stepsRemaining'] > 0:
				time.sleep(0.001)
				status = stage.xAxisNode.spinStatusRequest()	
		counter = counter + 1 #I added code
