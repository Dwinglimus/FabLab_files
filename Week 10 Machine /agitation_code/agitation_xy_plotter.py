...
class virtualMachine(machines.virtualMachine):
	...
	def initInterfaces(self):
		...
		else: self.fabnet = interfaces.gestaltInterface('FABNET', interfaces.serialInterface(baudRate = 115200, interfaceType = 'ftdi', portName = '/dev/cu.usbserial-FTZ56Q37'))
...
if __name__ == '__main__':
	...
	#i tried this and deleted the file it did not work
	...
	#stages.xyNode.setVelocityRequest(20)  #too fast the slave box moverd poorly got warm wont run again
	stages.xyNode.setVelocityRequest(15)  #too fast the slave box moverd poorly got warm wont run again
	...
	while counter < 3:
		...
		#moves = [[10,10],[20,20],[10,10],[0,0]] original
		#moves = [[-50,50],[0,0],[50,-50],[0,0]] longer run both same direction 2nd trial
		#moves = [[50,50],[0,0],[-50,-50],[0,0]] #longer run both oposite direction
		moves = [[5,5],[0,0],[-5,-5],[0,0]] #agitation mode 
		# Move!
		for move in moves:
			stages.move(move, 0)
